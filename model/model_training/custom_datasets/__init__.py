...
from model_training.custom_datasets.prompt_dialogue import DolphinMix, Gpt4All, OrcaChat, load_oig_file, BelugaChat
...
def get_one_dataset(
    ...
    **kwargs,
    ...
    elif dataset_name == "beluga_chat":
        dataset = BelugaChat(cache_dir=data_path, **kwargs)
    else:
